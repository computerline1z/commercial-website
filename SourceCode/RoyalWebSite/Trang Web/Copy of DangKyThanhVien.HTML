...
<div id="sidebar1">
  ...
  <div id="mainContent">
    ...
    &nbsp;
      &nbsp; &nbsp; Vật liệu xây dựng<table>
              <tr>
                  <td align="left">
                      Username:&nbsp;</td>
                  <td align="left" style="width: 158px">
                      <input id="Text1" runat="server" style="width: 144px" type="text" /></td>
                  <td align="left">
                      <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="Text1"
                          Display="Dynamic" ErrorMessage="Chưa nhập Username">(*)</asp:RequiredFieldValidator>
                      <asp:CustomValidator ID="CustomValidator1" runat="server" ControlToValidate="Text1"
                          ErrorMessage="Username trùng" OnServerValidate="CustomValidator1_ServerValidate"
              ...
              <tr style="color: #000000">
                  <td align="left">
                      Password:</td>
                  <td align="left" style="width: 158px">
                      <input id="Password2" runat="server" style="width: 144px" type="password" />
                  </td>
                  <td align="left">
                      <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="Password1"
                          Display="Dynamic" ErrorMessage="Chưa nhập Password">(*)</asp:RequiredFieldValidator></td>
              </tr>
              <tr style="color: #000000">
                  <td align="left" style="height: 21px">
                      Xác nhận Password:</td>
                  <td align="left" style="height: 21px">
                      <input id="Password1" runat="server" style="width: 144px" type="password" />
                  </td>
                  <td align="left">
                      <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="Password2"
                          Display="Dynamic" ErrorMessage="Chưa xác nhận lại Password">(*)</asp:RequiredFieldValidator>
                      <asp:CompareValidator ID="CompareValidator1" runat="server" ControlToCompare="Password1"
                          ControlToValidate="Password2" Display="Dynamic" ErrorMessage="Xác nhận Password chưa đúng">(*)</asp:CompareValidator></td>
              </tr>
              <tr>
                  <td align="left" style="height: 21px">
                      Email:</td>
                  <td align="left" style="width: 158px; height: 21px">
                      <input id="Text2" runat="server" style="width: 144px" type="text" />
                  </td>
                  <td align="left" style="height: 21px">
                      <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="Text2"
                          Display="Dynamic" ErrorMessage="Email không hợp lệ" ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*">(*)</asp:RegularExpressionValidator></td>
              </tr>
          </table>
      <p>
          <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="Đăng ký" />&nbsp;</p>
      <p>&nbsp;
          </p>
      <p>&nbsp;
          </p>
